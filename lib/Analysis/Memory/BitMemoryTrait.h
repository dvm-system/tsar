...
public:
  ...
  enum Id : unsigned long long {
    NoAccess =            111111111111111111_b,
    Readonly =            100111101111111111_b,
    SharedJoin =          000000001111111111_b,
    Shared =              100000101111111111_b,
    Private =             000011110111111111_b,
    FirstPrivate =        000011100111111111_b,
    SecondToLastPrivate = 000010110111111111_b,
    LastPrivate =         000001110111111111_b,
    DynamicPrivate =      000000110111111111_b,
    Dependency =          000000000111111111_b,
    Reduction =           001000000111111111_b,
    Induction =           010000000111111111_b,
    AddressAccess =       111111111011111111_b,
    HeaderAccess =        111111111101111111_b,
    ExplicitAccess =      111111111110111111_b,
    Lock =                111111111111011111_b,
    Redundant =           111111111111101111_b,
    NoRedundant =         111111111111110111_b,
    NoPromotedScalar =    111111111111111011_b,
    DirectAccess =        111111111111111101_b,
    IndirectAccess =      111111111111111110_b,
    AllUnitFlags =        111111111000000000_b,
  };
