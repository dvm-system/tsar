...
public:
  ...
  enum Id : unsigned long long {
    ...
    LastPrivate =         00000111011111111_b,
    DynamicPrivate =      00000011011111111_b,
    Dependency =          00000000011111111_b,
    Reduction =           00100000011111111_b,
    Induction =           01000000011111111_b,
    AddressAccess =       11111111101111111_b,
    HeaderAccess =        11111111110111111_b,
    ExplicitAccess =      11111111111011111_b,
    Lock =                11111111111101111_b,
    Redundant =           11111111111110111_b,
    NoRedundant =         11111111111111011_b,
    NoPromotedScalar =    11111111111111101_b,
    DirectAccess =        11111111111111110_b,
    AllUnitFlags =        11111111100000000_b,
  };
