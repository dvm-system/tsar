...
public:
  ...
  enum Id : unsigned long long {
    NoAccess =            1111111111111111_b,
    Readonly =            1001111011111111_b,
    SharedJoin =          0000000011111111_b,
    Shared =              1000001001111111_b,
    Private =             0000111101111111_b,
    FirstPrivate =        0000111001111111_b,
    SecondToLastPrivate = 0000101101111111_b,
    LastPrivate =         0000011101111111_b,
    DynamicPrivate =      0000001101111111_b,
    Dependency =          0000000001111111_b,
    Reduction =           0010000001111111_b,
    Induction =           0100000001111111_b,
    AddressAccess =       1111111110111111_b,
    HeaderAccess =        1111111111011111_b,
    ExplicitAccess =      1111111111101111_b,
    Lock =                1111111111110111_b,
    Redundant =           1111111111111011_b,
    NoRedundant =         1111111111111101_b,
    NoPromotedScalar =    1111111111111110_b,
    AllUnitFlags =        1111111110000000_b,
  };
