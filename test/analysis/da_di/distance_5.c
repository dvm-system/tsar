...
//CHECK:     <I:5[5:3], 4> | <J:3, 4> | <JStart:1, 4>
//CHECK:    explicit access (separate):
//CHECK:     <I:5[5:3], 4> <J:3, 4> <JStart:1, 4>
//CHECK:    lock (separate):
//CHECK:     <I:5[5:3], 4>
//CHECK:    direct access (separate):
//CHECK:     <I:5[5:3], 4> <J:3, 4> <JStart:1, 4> <U:2:10, 800>
//CHECK:   loop at depth 2 distance_5.c:6:5
//CHECK:     flow:
//CHECK:      <U:2:10, 800>:[1,1]
//CHECK:     induction:
//CHECK:      <J:3, 4>:[Int,1,10,1]
//CHECK:     read only:
//CHECK:      <I:5[5:3], 4>
//CHECK:     lock:
//CHECK:      <J:3, 4>
...
//CHECK:      <J:3, 4>
//CHECK:     explicit access:
//CHECK:      <I:5[5:3], 4> | <J:3, 4>
//CHECK:     explicit access (separate):
//CHECK:      <I:5[5:3], 4> <J:3, 4>
//CHECK:     lock (separate):
//CHECK:      <J:3, 4>
//CHECK:     direct access (separate):
//CHECK:      <I:5[5:3], 4> <J:3, 4> <U:2:10, 800>
