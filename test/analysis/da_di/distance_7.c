...
//CHECK:     <I:6[6:3], 4> | <J:8[8:5], 4> | <JStart, 4> bar():7:5
...
//CHECK:     <I:6[6:3], 4> <J:8[8:5], 4> <JStart, 4> <U:5:10, 800> bar():7:5
//CHECK:   loop at depth 2 distance_7.c:8:5
//CHECK:     output:
//CHECK:      <U:5:10, 800>
//CHECK:     induction:
//CHECK:      <J:8[8:5], 4>:[Int,,,1]
//CHECK:     read only:
//CHECK:      <I:6[6:3], 4>
//CHECK:     lock:
//CHECK:      <J:8[8:5], 4>
...
//CHECK:      <J:8[8:5], 4>
//CHECK:     explicit access:
//CHECK:      <I:6[6:3], 4> | <J:8[8:5], 4>
//CHECK:     explicit access (separate):
//CHECK:      <I:6[6:3], 4> <J:8[8:5], 4>
//CHECK:     lock (separate):
//CHECK:      <J:8[8:5], 4>
//CHECK:     direct access (separate):
//CHECK:      <I:6[6:3], 4> <J:8[8:5], 4> <U:5:10, 800>
