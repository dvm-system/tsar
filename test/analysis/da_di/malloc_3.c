...
//CHECK:    shared:
//CHECK:     <*P:{6:22|6}, ?> <*P:{8:5|9:7|12:5|13:7|6:9}, ?>
//CHECK:    first private:
//CHECK:     <*P:{6:22|6}, ?> <*P:{8:5|9:7|12:5|13:7|6:9}, ?>
...
//CHECK:     <*P:{8:5|9:7|12:5|13:7|6:9}, ?> <I:7[7:3], 4> <P:6, 8>
//CHECK:    indirect access (separate):
//CHECK:     <*P:{6:22|6}, ?>
//CHECK:  loop at depth 1 malloc_3.c:11:3
//CHECK:    shared:
//CHECK:     <*P:{10:16|6}, ?> <*P:{8:5|9:7|12:5|13:7|6:9}, ?>
//CHECK:    first private:
//CHECK:     <*P:{10:16|6}, ?> <*P:{8:5|9:7|12:5|13:7|6:9}, ?>
//CHECK:    dynamic private:
//CHECK:     <*P:{10:16|6}, ?> <*P:{8:5|9:7|12:5|13:7|6:9}, ?>
...
//CHECK:     <I:11[11:3], 4>
//CHECK:    direct access (separate):
//CHECK:     <*P:{8:5|9:7|12:5|13:7|6:9}, ?> <I:11[11:3], 4> <P:6, 8>
//CHECK:    indirect access (separate):
//CHECK:     <*P:{10:16|6}, ?>
...
//REDUNDANT:     <*P:{6:22|6}, ?>
//REDUNDANT:    induction:
//REDUNDANT:     <I:7[7:3], 4>:[Int,0,100,1]
//REDUNDANT:    read only:
//REDUNDANT:     <P:6, 8>
//REDUNDANT:    redundant:
//REDUNDANT:     <*P:{6:22|6}, ?> <*P:{8:5|9:7|12:5|13:7|6:9}, ?>
//REDUNDANT:    lock:
//REDUNDANT:     <I:7[7:3], 4>
//REDUNDANT:    header access:
//REDUNDANT:     <I:7[7:3], 4>
//REDUNDANT:    explicit access:
//REDUNDANT:     <I:7[7:3], 4> | <P:6, 8>
...
//REDUNDANT:     <P:6, 8>
//REDUNDANT:    redundant:
//REDUNDANT:     <*P:{10:16|6}, ?> <*P:{8:5|9:7|12:5|13:7|6:9}, ?>
//REDUNDANT:    lock:
//REDUNDANT:     <I:11[11:3], 4>
//REDUNDANT:    header access:
//REDUNDANT:     <I:11[11:3], 4>
//REDUNDANT:    explicit access:
//REDUNDANT:     <I:11[11:3], 4> | <P:6, 8>
//REDUNDANT:    explicit access (separate):
//REDUNDANT:     <I:11[11:3], 4> <P:6, 8>
//REDUNDANT:    redundant (separate):
//REDUNDANT:     <*P:{8:5|9:7|12:5|13:7|6:9}, ?>
