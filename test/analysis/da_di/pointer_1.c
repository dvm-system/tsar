...
//CHECK:     <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4>
//CHECK:    induction:
//CHECK:     <I:6[6:3], 4>:[Int,1,,1]
//CHECK:    read only:
//CHECK:     <A:3, 8> | <N, 4>
//CHECK:    redundant:
//CHECK:     <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4> | <X, 4>
//CHECK:    lock:
//CHECK:     <I:6[6:3], 4> | <N, 4> | <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4>
//CHECK:    header access:
//CHECK:     <I:6[6:3], 4> | <N, 4>
//CHECK:    explicit access:
//CHECK:     <A:3, 8> | <I:6[6:3], 4> | <N, 4> | <P:4, 8> | <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4>
//CHECK:    address access:
//CHECK:      <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4>
//CHECK:    explicit access (separate):
//CHECK:     <A:3, 8> <I:6[6:3], 4> <N, 4> <P:4, 8> <P[0]:{10:17|4:8}, 4> <Y, 4>
...
//CHECK:     <*A:3, ?> <A:3, 8> <I:6[6:3], 4> <N, 4> <P:4, 8> <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4>
//SAFE: Printing analysis 'Dependency Analysis (Metadata)' for function 'foo':
//SAFE:  loop at depth 1 pointer_1.c:6:3
//SAFE:    private:
//SAFE:     <P:4, 8>
//SAFE:    output:
//SAFE:     <*A:3, ?> <N, 4> <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4>
//SAFE:    anti:
//SAFE:     <*A:3, ?> <N, 4> <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4>
//SAFE:    flow:
//SAFE:     <*A:3, ?> <N, 4> <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4>
//SAFE:    induction:
//SAFE:     <I:6[6:3], 4>:[Int,1,,1]
//SAFE:    read only:
//SAFE:     <A:3, 8>
//SAFE:    redundant:
//SAFE:     <*A:3, ?> <N, 4> <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4>
//SAFE:    lock:
//SAFE:     <*A:3, ?> <N, 4> <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4> | <I:6[6:3], 4>
//SAFE:    header access:
//SAFE:     <*A:3, ?> <N, 4> <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4> | <I:6[6:3], 4>
//SAFE:    explicit access:
//SAFE:     <*A:3, ?> <N, 4> <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4> | <A:3, 8> | <I:6[6:3], 4> | <P:4, 8>
//SAFE:    address access:
//SAFE:     <*A:3, ?> <N, 4> <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4>
//SAFE:    explicit access (separate):
//SAFE:     <A:3, 8> <I:6[6:3], 4> <N, 4> <P:4, 8> <P[0]:{10:17|4:8}, 4> <Y, 4>
...
//SAFE:     <*A:3, ?> <A:3, 8> <I:6[6:3], 4> <N, 4> <P:4, 8> <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4>
...
//REDUNDANT:     <P:4, 8>
//REDUNDANT:    induction:
//REDUNDANT:     <I:6[6:3], 4>:[Int,1,,1]
//REDUNDANT:    read only:
//REDUNDANT:     <A:3, 8> | <N, 4>
//REDUNDANT:    redundant:
//REDUNDANT:     <*A:3, ?> <N, 4> <P[0]:{10:17|4:8}, 4> <X, 4> <Y, 4>
//REDUNDANT:    lock:
//REDUNDANT:     <I:6[6:3], 4> | <N, 4>
//REDUNDANT:    header access:
//REDUNDANT:     <I:6[6:3], 4> | <N, 4>
//REDUNDANT:    explicit access:
//REDUNDANT:     <A:3, 8> | <I:6[6:3], 4> | <N, 4> | <P:4, 8> | <Y, 4>
...
//REDUNDANT:     <*A:3, ?> <A:3, 8> <I:6[6:3], 4> <N, 4> <P:4, 8> <Y, 4>
