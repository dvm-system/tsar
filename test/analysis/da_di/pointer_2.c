...
//SAFE:     <P:6, 8>
//SAFE:    output:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?>
//SAFE:    anti:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?>
//SAFE:    flow:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?>
...
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?>
//SAFE:    lock:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?> | <I:8[8:3], 4>
//SAFE:    header access:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?> | <I:8[8:3], 4>
//SAFE:    explicit access:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?> | <A:5, 8> | <I:8[8:3], 4> | <P:6, 8>
//SAFE:    address access:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?>
//SAFE:    explicit access (separate):
//SAFE:     <A:5, 8> <I:8[8:3], 4> <N, 4> <P:6, 8> <P[0]:{12:17|6:14}, 4>
//SAFE:    lock (separate):
//SAFE:     <I:8[8:3], 4> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?>
...
//UNSAFE_TFM:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?>
//UNSAFE_TFM:    lock:
//UNSAFE_TFM:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?> | <I:8[8:3], 4>
//UNSAFE_TFM:    header access:
//UNSAFE_TFM:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?> | <I:8[8:3], 4>
//UNSAFE_TFM:    explicit access:
//UNSAFE_TFM:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?> | <A:5, 8> | <I:8[8:3], 4> | <P:6, 8>
//UNSAFE_TFM:    address access:
//UNSAFE_TFM:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?>
//UNSAFE_TFM:    explicit access (separate):
//UNSAFE_TFM:     <A:5, 8> <I:8[8:3], 4> <N, 4> <P:6, 8> <P[0]:{12:17|6:14}, 4>
...
//UNSAFE_TFM:     <*A:5, ?> <A:5, 8> <I:8[8:3], 4> <N, 4> <P:6, 8> <P[0]:{12:17|6:14}, 4> <X:6:7, ?> <Y:6:10, ?>
...
//UNSAFE_TFM_and_REDUNDANT:     <*A:5, ?> | <Y:6:10, ?>
...
//UNSAFE_TFM_and_REDUNDANT:     <A:5, 8> | <I:8[8:3], 4> | <N, 4> | <P:6, 8>
...
//UNSAFE_TFM_and_REDUNDANT:     <*A:5, ?> <A:5, 8> <I:8[8:3], 4> <N, 4> <P:6, 8> <X:6:7, ?> <Y:6:10, ?>
