...
//SAFE:     <P:6, 8>
//SAFE:    output:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//SAFE:    anti:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//SAFE:    flow:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//SAFE:    induction:
//SAFE:     <I:8[8:3], 4>:[Int,1,,1]
//SAFE:    read only:
//SAFE:     <A:5, 8>
//SAFE:    no promoted scalar:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//SAFE:    lock:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4> | <I:8[8:3], 4>
//SAFE:    header access:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4> | <I:8[8:3], 4>
//SAFE:    explicit access:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4> | <A:5, 8> | <I:8[8:3], 4> | <P:6, 8>
//SAFE:    address access:
//SAFE:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//SAFE:    explicit access (separate):
//SAFE:     <A:5, 8> <I:8[8:3], 4> <N, 4> <P:6, 8> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//SAFE:    lock (separate):
//SAFE:     <I:8[8:3], 4> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//SAFE:    address access (separate):
//SAFE:     <X:6:7, 4> <Y:6:10, 4>
//SAFE:    no promoted scalar (separate):
//SAFE:     <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//SAFE:    direct access (separate):
//SAFE:     <*A:5, ?> <A:5, 8> <I:8[8:3], 4> <N, 4> <P:6, 8> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//UNSAFE_TFM: Printing analysis 'Dependency Analysis (Metadata)' for function 'foo':
//UNSAFE_TFM:  loop at depth 1 pointer_2.c:8:3
//UNSAFE_TFM:    private:
//UNSAFE_TFM:     <P:6, 8>
//UNSAFE_TFM:    output:
//UNSAFE_TFM:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//UNSAFE_TFM:    anti:
//UNSAFE_TFM:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//UNSAFE_TFM:    flow:
//UNSAFE_TFM:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//UNSAFE_TFM:    induction:
//UNSAFE_TFM:     <I:8[8:3], 4>:[Int,1,,1]
...
//UNSAFE_TFM:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//UNSAFE_TFM:    lock:
//UNSAFE_TFM:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4> | <I:8[8:3], 4>
//UNSAFE_TFM:    header access:
//UNSAFE_TFM:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4> | <I:8[8:3], 4>
//UNSAFE_TFM:    explicit access:
//UNSAFE_TFM:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4> | <A:5, 8> | <I:8[8:3], 4> | <P:6, 8>
//UNSAFE_TFM:    address access:
//UNSAFE_TFM:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//UNSAFE_TFM:    explicit access (separate):
//UNSAFE_TFM:     <A:5, 8> <I:8[8:3], 4> <N, 4> <P:6, 8> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//UNSAFE_TFM:    redundant (separate):
//UNSAFE_TFM:     <P[0]:{12:17|6:14}, 4>
//UNSAFE_TFM:    lock (separate):
//UNSAFE_TFM:     <I:8[8:3], 4> <N, 4>
//UNSAFE_TFM:    address access (separate):
//UNSAFE_TFM:     <X:6:7, 4> <Y:6:10, 4>
//UNSAFE_TFM:    no promoted scalar (separate):
//UNSAFE_TFM:     <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//UNSAFE_TFM:    direct access (separate):
//UNSAFE_TFM:     <*A:5, ?> <A:5, 8> <I:8[8:3], 4> <N, 4> <P:6, 8> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
...
//UNSAFE_TFM_and_REDUNDANT:     <*A:5, ?>
//UNSAFE_TFM_and_REDUNDANT:    first private:
//UNSAFE_TFM_and_REDUNDANT:     <*A:5, ?> | <Y:6:10, 4>
//UNSAFE_TFM_and_REDUNDANT:    dynamic private:
//UNSAFE_TFM_and_REDUNDANT:     <*A:5, ?>
//UNSAFE_TFM_and_REDUNDANT:    second to last private:
//UNSAFE_TFM_and_REDUNDANT:     <Y:6:10, 4>
//UNSAFE_TFM_and_REDUNDANT:    private:
//UNSAFE_TFM_and_REDUNDANT:     <P:6, 8>
//UNSAFE_TFM_and_REDUNDANT:    induction:
//UNSAFE_TFM_and_REDUNDANT:     <I:8[8:3], 4>:[Int,1,,1]
//UNSAFE_TFM_and_REDUNDANT:    read only:
//UNSAFE_TFM_and_REDUNDANT:     <A:5, 8> | <N, 4> | <X:6:7, 4>
//UNSAFE_TFM_and_REDUNDANT:    no promoted scalar:
//UNSAFE_TFM_and_REDUNDANT:     <X:6:7, 4> | <Y:6:10, 4>
//UNSAFE_TFM_and_REDUNDANT:    redundant:
//UNSAFE_TFM_and_REDUNDANT:     <*A:5, ?> <N, 4> <P[0]:{12:17|6:14}, 4> <X:6:7, 4> <Y:6:10, 4>
//UNSAFE_TFM_and_REDUNDANT:    lock:
//UNSAFE_TFM_and_REDUNDANT:     <I:8[8:3], 4> | <N, 4>
//UNSAFE_TFM_and_REDUNDANT:    header access:
//UNSAFE_TFM_and_REDUNDANT:     <I:8[8:3], 4> | <N, 4>
//UNSAFE_TFM_and_REDUNDANT:    explicit access:
//UNSAFE_TFM_and_REDUNDANT:     <A:5, 8> | <I:8[8:3], 4> | <N, 4> | <P:6, 8> | <X:6:7, 4> | <Y:6:10, 4>
...
//UNSAFE_TFM_and_REDUNDANT:     <*A:5, ?> <A:5, 8> <I:8[8:3], 4> <N, 4> <P:6, 8> <X:6:7, 4> <Y:6:10, 4>
