...
//CHECK:     <XPtr:8:10, 8>
//CHECK:    output:
//CHECK:     <S:4, 4> <X:4, 4> <XPtr[0]:{9:6|8:10}, 4> <Z, 4>
//CHECK:    anti:
//CHECK:     <S:4, 4> <X:4, 4> <XPtr[0]:{9:6|8:10}, 4> <Z, 4>
//CHECK:    flow:
//CHECK:     <S:4, 4> <X:4, 4> <XPtr[0]:{9:6|8:10}, 4> <Z, 4>
...
//CHECK:    redundant:
//CHECK:     <S:4, 4> <X:4, 4> <XPtr[0]:{9:6|8:10}, 4> <Z, 4> | <XPtr:8:10, 8>
//CHECK:    lock:
//CHECK:     <I:7[7:3], 4>
//CHECK:    header access:
//CHECK:     <I:7[7:3], 4>
//CHECK:    explicit access:
//CHECK:     <I:7[7:3], 4> | <S:4, 4> <X:4, 4> <XPtr[0]:{9:6|8:10}, 4> <Z, 4> | <XPtr:8:10, 8>
//CHECK:    explicit access (separate):
//CHECK:     <I:7[7:3], 4> <S:4, 4> <X:4, 4> <XPtr:8:10, 8> <XPtr[0]:{9:6|8:10}, 4> <Z, 4>
...
//REDUNDANT:    reduction:
//REDUNDANT:     <S:4, 4>:mult
//REDUNDANT:    read only:
//REDUNDANT:     <Z, 4>
//REDUNDANT:    redundant:
//REDUNDANT:     <S:4, 4> <X:4, 4> <XPtr[0]:{9:6|8:10}, 4> <Z, 4> | <XPtr:8:10, 8>
//REDUNDANT:    lock:
//REDUNDANT:     <I:7[7:3], 4>
//REDUNDANT:    header access:
//REDUNDANT:     <I:7[7:3], 4>
//REDUNDANT:    explicit access:
//REDUNDANT:     <I:7[7:3], 4> | <S:4, 4> | <X:4, 4> | <Z, 4>
